	...
	<div class="container">
		<div class="row">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">订单编号:<span id="oid" value="${oid}">${oid}</span></th>
						</tr>
						<tr class="warning">
							<th>图片</th>
							<th>商品</th>
						...
						<c:forEach items="${shopcartList}" var="shopcartItem">
							<tr class="active">
								...
								<td width="30%">
									<a target="_blank">${shopcartItem.product.pname}</a>
								</td>
								<td width="20%">
									￥${shopcartItem.shopprice}
								</td>
								<td width="10%">${shopcartItem.count}</td>
								<td width="15%">
			...
			<div style="text-align: right; margin-right: 120px;">
				商品总金额: <strong style="color: #ff6600;">￥${total}元</strong>
			</div>
		</div>
		...
		<div>
			...
			<form class="form-horizontal" style="margin-top: 5px; margin-left: 150px;"
					action="addorder.action" id="orderForm" name="orderForm">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				...
				<p>
					...
					<input type="radio" name="pd_FrpId" value="ICBC-NET-B2C"
						...
						align="middle" />&nbsp;&nbsp;&nbsp;&nbsp; 
					<input type="radio"
						name="pd_FrpId" value="BOC-NET-B2C" /><img
					...
					<input type="radio" name="pd_FrpId" value="ABC-NET-B2C" /><img
						...
						type="radio" name="pd_FrpId" value="BOCO-NET-B2C" /><img
